...
CREATE TABLE IF NOT EXISTS `acoes`.`administracion_apadrinamiento` (
                                                                     ...
                                                                     INDEX `fk_administracion_apadrinamiento_apadrinamiento1_idx` (`apadrinamiento_id` ASC, `apadrinamiento_apadrinado` ASC, `apadrinamiento_padrino` ASC),
...
CREATE TABLE IF NOT EXISTS `acoes`.`envio` (
                                             ...
                                             INDEX `fk_envio_apadrinamiento1_idx` (`apadrinamiento_id` ASC, `apadrinamiento_apadrinado` ASC, `apadrinamiento_padrino` ASC),
